...
class Conversationadapter(private val homelist: List<Beginner>) :
    RecyclerView.Adapter<Conversationadapter.ViewHolder>(), TextToSpeech.OnInitListener {
    private lateinit var tts: TextToSpeech

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {

        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.itemconversation, parent, false)
