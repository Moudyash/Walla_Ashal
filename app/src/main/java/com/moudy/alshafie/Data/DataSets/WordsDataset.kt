...
class WordsDataset {
     ...
     var BeginnerEN = arrayOf("Baby", "Mother", "Father", "Mom", "Home", "Cow", "Dog", "Play", "cat", "car", "sun", "top", "old", "good",
        ...
        "sing", "bike", "bird", "cake", "candy", "cold", "cry", "door", "dress", "funny", "fun", "hat", "pan", "Girl")
      var BeginnerAr_En = arrayOf("tifl", "um", "ab", "umiy", "almanzil", "baqara", "kalb", "Play", "cat", "car", "sun", "top", "old", "good",
        "red", "into", "about", "apple", "milk", "show", "sick", "sky", "small", "snow", "food", "men", "mine", "fish", "shoe", "before", "Brother",
        "sister", "child", "club", "tree", "Moon", "night", "now", "here", "yes", "you", "dad", "day", "box", "stop", "bed", "long", "floor",
        "soon", "some", "ask", "bag", "base", "fire", "many", "meat", "sing", "see", "sit", "toy", "after", "away", "back", "fly", "side", "lost", "sheep",
        "sing", "bike", "bird", "cake", "candy", "cold", "cry", "door", "dress", "funny", "fun", "hat", "pan", "Girl")

     var BeginnerAR = arrayOf("طفل", "أم", "أب", "أمي", "المنزل", "بقرة", "كلب", "يلعب", "قطة", "سيارة", "شمس", "قمة", "قديم", "جيد",
        "أحمر", "في", "حول", "تفاحة", "حليب", "عرض", "مريض", "سماء", "صغير", "ثلج", "طعام", "رجال", "ألغام", "سمك", "حذاء", "قبل", "أخ",
        "أخت", "طفل", "نادي", "شجرة", "القمر", "ليل", "الآن", "هنا", "نعم", "أنت", "أب", "يوم", "صندوق", "توقف", "سرير", "طويل", "أرضية",
        "قريباً", "بعض", "يسأل", "حقيبة", "قاعدة", "نار", "كثير", "لحم", "يغني", "يرى", "يجلس", "لعبة", "بعد", "بعيداً", "عودة", "يطير", "جانب", "ضائع", "غنم",
        "يغني", "دراجة", "طير", "كعكة", "حلوى", "برد", "يبكي", "باب", "فستان", "مضحك", "مرح", "قبعة", "مقلاة", "فتاة")
         var NormalEN = arrayOf("Absent-minded", "Adventurous", "Arrogant", "Snobbish", "Conceited", "Bad-tempered", "Boring", "Brave", "Calm", "Cautious",
             ...
             "Cook", "Copywriter", "Decorator")

         var NormalAR = arrayOf("غائب الذهن", "مغامر", "متعجرف", "متكبر", "متغطرس", "سيء الطباع", "ممل", "شجاع", "هادئ", "حذر", "مبتهج", "ذكي", "واثق", "جبان", "مجنون",
             "غير صادق", "سهل الانصراف", "عاطفي", "ودود", "مضحك", "سخي", "ذو نكتة حسنة", "مجتهد", "صادق", "غير صبور", "غير مهذب", "اندفاعي", "ذكي", "منعزل", "لطيف", "كسول",
             "شرير", "متواضع", "غير مستقر نفسيًا", "صبور", "مهذب", "غير مهذب", "عاقل", "حساس", "جدي", "خجول", "راقي", "غبي", "موهوب", "غير ودود", "بديهي الفكرة","واقعي ومتواضع",  "محاسب",
             "ممثل", "ممثلة", "مضيفة طيران","مضيف طيران", "عالم آثار", "فنان", "عالم انسان", "خباز", "راقصة باليه", "مدير مصرف", "حلاق", "خبيرة تجميل", "عالم احياء",
             "منضف أحذية", "عالم نبات", "بناء", "جزار", "مشتري", "نجار", "طباخ", "كيميائي", "رئيس الشرطة", "موظف حكومي", "كاتب محاسب", "ملحن", "طباخ", "كاتب نسخ")
         var NormalAR_EN = arrayOf("غائب الذهن", "مغامر", "متعجرف", "متكبر", "متغطرس", "سيء الطباع", "ممل", "شجاع", "هادئ", "حذر", "مبتهج", "ذكي", "واثق", "جبان", "مجنون",
             "غير صادق", "سهل الانصراف", "عاطفي", "ودود", "مضحك", "سخي", "ذو نكتة حسنة", "مجتهد", "صادق", "غير صبور", "غير مهذب", "اندفاعي", "ذكي", "منعزل", "لطيف", "كسول",
             "شرير", "متواضع", "غير مستقر نفسيًا", "صبور", "مهذب", "غير مهذب", "عاقل", "حساس", "جدي", "خجول", "راقي", "غبي", "موهوب", "غير ودود", "بديهي الفكرة","واقعي ومتواضع", "محاسب",
             "ممثل", "ممثلة", "مضيف طيران","مضيف طيران", "عالم آثار", "فنان", "عالم انسان", "خباز", "راقصة باليه", "مدير مصرف", "حلاق", "خبيرة تجميل", "عالم احياء",
             "منضف أحذية", "عالم نبات", "بناء", "جزار", "مشتري", "نجار", "طباخ", "كيميائي", "رئيس الشرطة", "موظف حكومي", "كاتب محاسب", "ملحن", "طباخ", "كاتب نسخ")

         var ExpertEN = arrayOf(
             "Hi / Hello","Good morning","Good afternoon","Good evening","How are you","Excuse me", "What is your name?","Where are you from?","How old are you?",
         ...
         var ExpertAR = arrayOf(
             "مرحبا / السلام عليكم","صباح الخير","مساء الخير","مساء الجميل","كيف حالك؟","عفوًا","ما هو اسمك؟","من أين أنت؟","كم عمرك؟",
